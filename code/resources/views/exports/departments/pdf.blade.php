        ...
        <thead>
            <tr>
                @foreach ($columns as $col)
                    <th>{{ \Illuminate\Support\Arr::get(\App\Filament\Resources\Departments\DepartmentResource::getExportableColumns(), $col, $col) }}</th>
                @endforeach
            </tr>
        </thead>
        <tbody>
                ...
                <tr>
                    @foreach ($columns as $col)
                        <td>
                            ...
                            @if (is_bool($value))
                                {{ $value ? 'Sí' : 'No' }}
                            @elseif ($col === 'budget_limit' && is_numeric($value))
