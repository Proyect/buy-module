...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (empty($tableNames)) {
            throw new RuntimeException('Error: config/permission.php not loaded. Publish the config file or clear the configuration cache.');
        }
        ...
        Schema::create($tableNames['roles'], function (Blueprint $table) use ($teams, $columnNames) {
            $table->bigIncrements('id');
            if ($teams || config('permission.testing')) { // teams feature
